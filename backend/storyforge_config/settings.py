...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-temporary-debug-key-CHANGE-ME')
...
ROOT_URLCONF = 'storyforge_config.urls'
...
WSGI_APPLICATION = 'storyforge_config.wsgi.application'
